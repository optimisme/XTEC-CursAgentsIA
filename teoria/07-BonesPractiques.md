...
## 16. Criteris per saber quan parar

Un agent no ha de continuar indefinidament.

Ha de parar quan:

* ha completat l'objectiu;
* ha executat les comprovacions acordades;
* ha explicat els canvis;
* necessita una decisió de l'usuari;
* ha trobat un bloqueig que no pot resoldre;
* continuar implicaria canvis fora de l'abast.

També ha de saber evitar millores no demanades.

Si la tasca és arreglar un bug, no cal refactoritzar tota l'aplicació.

Si la tasca és documentar un tema, no cal canviar el codi.

---

## 17. Checklist final

Abans de donar una tasca per acabada, podem revisar:

```text
[ ] L'objectiu està clar?
[ ] El context necessari està disponible?
[ ] Les eines són les adequades?
[ ] Les sortides del model es validen?
[ ] Els errors es mostren de manera útil?
[ ] S'han executat les comprovacions raonables?
[ ] La documentació del projecte queda actualitzada?
[ ] L'agent sap quan ha de parar?
```

La idea central del curs és aquesta: un agent és útil quan combina raonament, context, eines i validació dins d'un procés controlat.
