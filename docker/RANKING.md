...
1. ⭐⭐ compose-qwen36-35b-a3b-base-cuda-vram16-llamacpp-localweights-iq4-mtp.yml (llama.cpp GGUF, NVIDIA CUDA, alta capacitat però poca concurrència, imatge via mmproj Unsloth en CPU)
