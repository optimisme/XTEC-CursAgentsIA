...
2. compose-qwen36-35b-a3b-cuda-vram96-vllm-nvidia-nvfp4.yml (checkpoint NVIDIA NVFP4, text-only, context 32k, perfil ajustat per 96GB)
3. compose-qwen36-35b-a3b-cuda-vram128-vllm-qwen-fp8.yml (checkpoint Qwen FP8, fallback si NVFP4 dona regressions)
...
1. compose-ministral3-3b-instruct-cuda-vram16-vllm-mistral-fp8-128k.yml (Ministral 3 3B Instruct FP8, vLLM 0.23.0, tools, text-only, context 128k, port 8000)
2. compose-qwen36-35b-a3b-base-cuda-vram16-llamacpp-localweights-iq4-mtp.yml (llama.cpp GGUF, NVIDIA CUDA, alta capacitat però poca concurrència)
